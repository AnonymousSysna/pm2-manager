    ...
    <section className="mx-auto max-w-3xl space-y-4">
      ...
      <div className="page-panel">
        ...
        <form onSubmit={submit} className="space-y-4">
          ...
          {isLaunching && <Banner tone="info">Launch in progress. Keep this page open. Elapsed: {launchElapsedSec}s</Banner>}
      ...
      {isLaunching && (
        ...
        >
          <div className="space-y-4">
            ...
            <SupportingCopy size="xs" className="text-center">Elapsed: {launchElapsedSec}s</SupportingCopy>
            <InsetCard>
              ...
              <div className="max-h-48 space-y-1 overflow-y-auto">
                ...
                {liveCreateSteps.map((step) => {
                  ...
                  return (
                    <InsetCard key={String(step.stepId || step.label || "")} padding="sm" tone="surface" className="text-xs">
                      <StatusText as="p" tone={tone}>
