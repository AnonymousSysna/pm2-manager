export const semanticToneClasses = {
  success: {
    badge: "border border-success-500/30 bg-success-500/10 text-success-300",
  ...
  danger: {
    badge: "border border-danger-500/30 bg-danger-500/10 text-danger-300",
  ...
  warning: {
    badge: "border border-warning-500/30 bg-warning-500/10 text-warning-300",
  ...
  info: {
    badge: "border border-info-500/30 bg-info-500/10 text-info-300",
